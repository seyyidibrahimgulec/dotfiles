...
#+begin_src haskell :tangle .xmonad/xmonad.hs
  ...
  myStartupHook = do
    ...
    spawnOnce "flameshot"
    spawn ("sleep 2 && trayer --distance 10 --margin 18 --edge top --align right --widthtype request --padding 5 --SetDockType true --SetPartialStrut true --expand true --monitor 1 --iconspacing 8 --transparent true --alpha 0 --tint 0x1a1b26 --height 40")
#+end_src
** Main
#+begin_src haskell :tangle .xmonad/xmonad.hs
